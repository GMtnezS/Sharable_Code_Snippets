...
# Step 1: Ensure JUnit, Hamcrest, and Mockito JAR files exist in the lib folder
...
echo "Running tests..."
java -cp tmp:lib/junit-4.13.2.jar:lib/hamcrest-all-1.3.jar org.junit.runner.JUnitCore RecursiveProductTest
